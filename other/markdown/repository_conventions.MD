...
* dealing with meta data (if single row value per object, keep in metadata single file...otherwise, e.g. TLS (depth, period, etc.), store in separate files)
* switch to feather files rather than csv
* 
